...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geosci-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12827&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geosci-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geosci` can be installed with:

```
conda install geosci
```

It is possible to list all of the versions of `geosci` available on your platform with:
